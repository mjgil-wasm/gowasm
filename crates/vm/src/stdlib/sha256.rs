use super::{StdlibFunction, SHA256_SUM256};
use crate::{Program, Value, ValueData, Vm, VmError};

pub(super) const SHA256_FUNCTIONS: &[StdlibFunction] = &[StdlibFunction {
    id: SHA256_SUM256,
    symbol: "Sum256",
    returns_value: true,
    handler: sha256_sum256,
}];

fn sha256_sum256(vm: &mut Vm, program: &Program, args: &[Value]) -> Result<Value, VmError> {
    if args.len() != 1 {
...
pub(super) const SHA256_BLOCK_SIZE: i64 = 64;
pub(super) const SHA256_SIZE: i64 = 32;
