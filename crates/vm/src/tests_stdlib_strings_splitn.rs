...
fn strings_split_n() -> super::StdlibFunctionId {
    resolve_stdlib_function("strings", "SplitN").expect("strings.SplitN should be registered")
}

#[test]
fn executes_strings_split_n_queries() {
    let program = Program {
        entry_function: 0,
        methods: vec![],
        global_count: 0,
